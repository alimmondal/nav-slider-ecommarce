            ...
            <div className="card">
              ...
              <div className="product-content">
                      ...
                      <ul>
                        ...
                        {product.countInStock > 0 ? (
                          ...
                          <span style={{ display: "flex" }}>
                            <i class="far fa-minus-square"></i>OUT OF STOCK{" "}
                          </span>
                        )}
                      </ul>
                    </div>
                ...
                <div className="purchase-info">
                  ...
                  >
                    {" "}
                    <i className="fas fa-shopping-cart" size="24"></i>
                    Add to Cart{" "}
                  </Button>
                </div>
                ...
                <div className="social-links">
                  ...
                  <Link className="social" to="#">
                    <i>
                      {" "}
                      <i className="fab fa-facebook" size="24"></i>
                    </i>
                  </Link>
                  <Link className="social" href="#">
                    <i>
                      <i className="fab fa-twitter" size="24"></i>
                    </i>
                  </Link>
                  <Link className="social" href="#">
                    <i>
                      <i className="fab instagram" size="24"></i>{" "}
                    </i>
                  </Link>
                </div>
              </div>
